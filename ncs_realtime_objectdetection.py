...
CLASSES = ("background", "aeroplane", "bicycle", "bird",
	...
	"handbag", "skis", "skateboard", "couch", "microwave",
	"umbrella", "teddy bear", "hot dog", "snowboard", "potted plant", 
	"sink", "toilet", "apple", "scissors", "tie", "motorcycle",
	"tv", "oven", "book", "keyboard", "truck", "fire hydrant", "stop sign",
	"sports ball", "toaster", "backpack", "traffic light", "bowl", "refrigerator"
	"surfboard", "broccoli", "donut", "airplane",
	"pizza", "sandwich", "suitcase", "vase", "hat", "cell phone", "wine glass",
	"cup", "fork", "carrot", "baseball bat", "tennis racket", "mouse",
	"knife", "kite", "baseball glove", "sheep", "bed", "dining table",
	"remote", "zebra", "hair dryer", "spoon", "frisbee", "orange", "parking meter",
	"giraffe", "bottle", "laptop", "elephant", "clock", "bear", "toothbrush",
	"bench") 
