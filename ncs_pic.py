...
CLASSES = ("background", "aeroplane", "bicycle", "bird",
	...
	"pottedplant", "sheep", "sofa", "train", "tvmonitor", "banana", 
	"street sign", "handbag", "skis", "skateboard", "couch", "microwave",
	"umbrella", "window", "teddy bear", "hot dog", "snowboard", "potted plant", 
	"sink", "toilet", "apple", "scissors", "door", "desk", "tie", "motorcycle",
	"tv", "oven", "book", "keyboard", "truck", "fire hydrant", "stop sign",
	"sports ball", "toaster", "backpack", "traffic light", "bowl", "refrigerator"
	"surfboard", "broccoli", "donut", "hair brush", "airplane", "plate", "eyeglasses",
	"pizza", "sandwich", "suitcase", "vase", "hat", "cell phone", "wine glass",
	"cup", "fork", "carrot", "baseball bat", "tennis racket", "mirror", "mouse",
	"blender", "knife", "kite", "baseball glove", "sheep", "bed", "dining table",
	"remote", "zebra", "hair dryer", "spoon", "frisbee", "orange", "parking meter",
	"giraffe", "bottle", "laptop", "elephant", "clock", "shoe", "bear", "toothbrush",
	"bench") 
...
ap.add_argument("-c", "--confidence", default=.25,
